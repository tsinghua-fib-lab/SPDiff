...
class MultimodalGenerativeCVAE(object):
    def __init__(self,
        ...
        self.device = device
        self.edge_types = [edge_type for edge_type in edge_types if edge_type[0] is node_type] # only consider the start of edge is equal to node_type
        self.curr_iter = 0
        ...
        self.state = self.hyperparams['state']  # state: known in history
        self.pred_state = self.hyperparams['pred_state'][node_type] # pred_state: states to be predicted
